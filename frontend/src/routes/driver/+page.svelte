<script>
  ...
  const isVerified = $derived(isAdmin || dbUser?.verificationStatus === 'VERIFIED');
  const verificationStatus = $derived(dbUser?.verificationStatus || 'UNVERIFIED');
    ...
    <div class="card-body text-center py-5">
      {#if verificationStatus === 'UNVERIFIED'}
        ...
        <p class="text-muted mb-4">
          To access the Driver Dashboard and create rides, you need to verify your identity first.
        </p>
      ...
      {:else if verificationStatus === 'PENDING'}
        ...
        <p class="text-muted mb-4">
          Your verification request is being reviewed. This usually takes 1-2 business days.<br>
          ...
          <div class="col-md-6 col-lg-4 mb-3">
            <div class="card h-100">
              ...
              <div class="card-footer d-flex gap-2">
                <form method="POST" action="?/approveBooking" use:enhance={handleSubmit} class="d-inline">
                  <input type="hidden" name="bookingId" value={booking.id} />
                  <button type="submit" class="btn btn-success btn-sm">✓ Approve</button>
                </form>
                <form method="POST" action="?/rejectBooking" use:enhance={handleSubmit} class="d-inline">
                  <input type="hidden" name="bookingId" value={booking.id} />
